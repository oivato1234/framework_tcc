...
<a class= "voltar" href="/tcc/menu.php"><b>Voltar</b></a><br><br>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="hd.png" class="d-block w-25"> <br><br><br><br>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="hd_disc.png" class="d-block w-25"><br><br><br><br>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="hd_entrada.png" class="d-block w-25"><br><br><br><br>
...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active"> 
      <img src="sata.png" class="d-block w-25"><br><br><br><br>
