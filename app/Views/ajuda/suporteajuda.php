...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <p class="texto">Placa Mãe e onde vão os seus respectivos componentes</p>
    </div>
  </div>
</div><br><br>
  <h2 class="texto1">Processador</h2>
  <p class="texto1">Processador: trabalha a informação gerada durante a operação do computador, processando cada função acionada. Em suma, o processador, como o próprio nome já diz, é o responsável por todo o processamento de dados da máquina. Exemplo: interpretar as ações do botão do mouse e fazer com que o Word abra o arquivo solicitado. </p>
...
<h2 class="texto1">HD</h2>
  <p class="texto1">HD: O hard disk ou HD é o responsável pelo armazenamento e, por isso, pode gravar e regravar informações. Salva dados de arquivo e sistema operacional.</p>
